...
A production-ready cloud-native streaming data platform using Azure Event Hubs, Databricks, ADLS Gen2, Delta Lake, and Terraform. The platform ingests events through Event Hubs, processes them with PySpark Structured Streaming, and writes deduplicated data to Delta Lake.
...
A live portfolio site showcasing data engineering experience, certifications, technical skills, and projects. Built with HTML/CSS and hosted on GitHub Pages.

**Key Features:**
- Responsive design optimized for mobile and desktop
- Project showcases with live links and code repositories
- Certification verification links
- Interactive skills visualization
- SEO optimization for better visibility

**Skills:** HTML, CSS, GitHub Pages, Web Design, Portfolio Development
...
- **CGPA:** 7.99/10.0
- **Additional:** JEE Mains – 94.14 Percentile (Top 6% nationally)
...
- **Big Data:** PySpark, Apache Spark, Databricks, Microsoft Fabric, Delta Lake, Apache Kafka, Azure Event Hubs
...
- Building scalable data platforms and lakehouse architectures
- Exploring production LLM systems and RAG applications
- Contributing to open-source data engineering projects
- Learning about cloud-native technologies (Kubernetes, Terraform)
